...
# --- 1.6 ΣΥΝΤΗΡΗΣΗ & HACCP (ULΤΙΜΑΤΕ VERSION) ---
    ...
    with tab2:
        tasks_data = {
            "Ημερήσιος Καθαρισμός": ["Σκεύη (ταψιά, πιάτα κτλ)", "Εργαλεία (μαχαίρια, κουτάλια, σπάτουλες κτλ)", "Εξοπλισμός (μηχανές τεμαχισμού, μηχανές επεξεργασίας κτλ)", "Επιφάνειες που έρχονται σε επαφή με τρόφιμα", "Δάπεδα χώροτ παραγωγής, πόμολα και διακόπτες", "Τουαλέτες - Αποδυτήρια", "Απομάκρυνση απορριμμάτων", "Δάπεδα χώρου πώλησης" ],
